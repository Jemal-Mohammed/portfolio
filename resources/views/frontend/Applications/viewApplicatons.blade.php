...
<head>
  ...
  <title>Posisions kiot Icms</title>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row mt-5">
              ...
              <div class="col-md-6 d-flex align-items-stretch">
                <div class="card">
                  <div class="card-body">
                    <h5 class="card-title"><a href="">work area: {{$apply->position->title}}</a></h5>
                    <p class="fst-italic text-center">company name:</address>{{$apply->position->companyName}}</p>
                    <p class="fst-italic text-center">address of the company :</address>{{$apply->position->address}}</p>
                    <p class="card-text">City: {{$apply->position->city}}</p>
                    <p class="card-text">status: {{$apply->status}}</p>

                    <div class="row justify-content-end mt-2">
                        <form action="{{url('sendFeedBack',$apply->id)}}" class="row justify-content-end" method="POST">
                            @csrf
                            <div>
                        ...
                        <h5 class="text-danger">*{{$errors->first('feedback')}}</h5>
                        @endif
                            </div>
