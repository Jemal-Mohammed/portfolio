...
<section class="section dashboard">
    ...
    <div class="col-lg-8">
        <div class="card">
          <div class="card-body">
            <h5 class="card-title text-success">Add Carrers</h5>
            <!-- Vertical Form -->
            <form class="row g-3" action="{{url('addCarrers')}}" method="POST">
                @csrf
              <div class="col-12">
              ...
              <div class="col-12">
                <label for="inputNanme4" class="form-label">Carrer title</label>
              ...
              <div class="col-12">
                <label for="inputPassword4" class="form-label">Salry</label>
                <input type="text" class="form-control" name="salery" id="inputPassword4">
                @if ($errors->has('salery'))
                <h5 class="text-danger">*{{$errors->first('salery')}}</h5>
                @endif
              </div>
